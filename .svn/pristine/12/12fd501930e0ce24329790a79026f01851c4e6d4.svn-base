...
static CGFloat const nodeSide = 40.0f;
...
- (void)layoutSubviews {
    ...
    CGFloat nodeSeperation = availableWidth / 3;
    ...
    NSDictionary *metrics = @{@"padding":@(nodeSeperation), @"marginPadding":@(marginpadding)};
    
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(marginPadding)-[node1]-(padding)-[node2]-(padding)-[node3]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(marginPadding)-[node4]-(padding)-[node5]-(padding)-[node6]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(marginPadding)-[node7]-(padding)-[node8]-(padding)-[node9]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(marginPadding)-[node1]-(padding)-[node4]-(padding)-[node7]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(marginPadding)-[node2]-(padding)-[node5]-(padding)-[node8]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(marginPadding)-[node3]-(padding)-[node6]-(padding)-[node9]-(marginPadding)-|"
                                                                 options:kNilOptions
                                                                 metrics:metrics
                                                                   views:views]];
