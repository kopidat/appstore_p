...
- (void)webView:(WKWebView *)webView didFinishNavigation:(null_unspecified WKNavigation *)navigation {
    ...
    if (_getGlobalValue(@"storeOpenInfo") != nil && ![_getGlobalValue(@"storeOpenInfo") isEqualToString:@""]) {
        NSDictionary *storeOpenInfoDic = [_getGlobalValue(@"storeOpenInfo") objectFromJsonString];
        NSString *type = [storeOpenInfoDic objectForKey:@"type"];
        NSString *appName = [storeOpenInfoDic objectForKey:@"appName"];
        [self callCbfunction:@"fn_storeopen" withObjects:appName, type, nil];
        _setGlobalValue(@"storeOpenInfo", @"");
    }
}
